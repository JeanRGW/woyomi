...
const en = {
    ...
    'library.sortStatus': 'Status',
    'library.browseSources': 'Explore sources',
    'library.noMatchesTitle': 'No matches found',
    'library.noMatchesHint': 'Try changing your search or status filter.',
    ...
    'downloads.dashUnsupported': 'Offline download is unavailable because this episode only provides DASH streams.',
    ...
    'media.startReading': 'Start reading',
    'media.startWatching': 'Start watching',
    'media.resumeChapter': 'Resume Ch. {number}',
    'media.resumeEpisode': 'Resume Ep. {number}',
    'media.readMore': 'Read more',
    'media.readLess': 'Read less',
    'media.sortAsc': 'Oldest first',
    'media.sortDesc': 'Newest first',
    'media.filterChapters': 'Filter chapters…',
    'media.filterEpisodes': 'Filter episodes…',
    ...
    'history.clearConfirmTitle': 'Clear watch & read history?',
    'history.clearConfirmHint': 'This will remove all items from your history. Your saved library and progress will remain intact.',
    'history.clearedToast': 'History cleared',
    'history.exploreLibrary': 'Go to library',
    ...
    'store.updateAll': 'Update all ({count})',
    'store.updatedAllToast': 'Updated {count} plugins',
    'store.emptyTitle': 'No plugins found',
    'store.emptyHint': 'Add a plugin repository URL above to discover installable sources.',
    'store.noMatchesTitle': 'No matching plugins',
    'store.noMatchesHint': 'Try changing your search keywords or filter.',
    'store.nsfw': 'NSFW',
    ...
    'player.metadataLoadFailed': 'Could not load this episode.',
    'player.noStreams': 'No playable streams returned.',
    'player.play': 'Play',
    'player.pause': 'Pause',
    'player.buffering': 'Buffering',
    'player.pausedStatus': 'Playback paused',
    'player.endedStatus': 'Playback ended',
    'player.replay': 'Replay',
    'player.seekBack': 'Back {seconds} seconds',
    'player.seekForward': 'Forward {seconds} seconds',
    'player.seekBackFeedback': '−{seconds}s',
    'player.seekForwardFeedback': '+{seconds}s',
    'player.timeline': 'Playback position',
    'player.live': 'LIVE',
    'player.jumpToLive': 'Jump to live',
    ...
    'player.lock': 'Lock controls',
    'player.unlock': 'Unlock controls',
    'player.swipeToUnlock': 'Swipe to unlock',
    'player.settings': 'Player settings',
    'player.fit': 'Video fit',
    'player.fitScreen': 'Fit screen',
    'player.fitCrop': 'Crop to fill',
    'player.autoNext': 'Play next episode automatically',
    'player.autoRotate': 'Rotate phones to landscape',
    'player.offline': 'Offline',
    'player.resumedAt': 'Resumed at {time}',
    'player.startOver': 'Start over',
    'player.retry': 'Retry',
    'player.chooseSource': 'Choose source',
    'player.playbackFailed': 'Video playback failed',
    'player.streamLoadFailed': 'Could not load video streams.',
    'player.hlsUnsupported': 'This device cannot play this HLS stream.',
    'player.dashUnsupported': 'This device cannot play this DASH stream.',
    'player.tryingAnotherStream': 'Trying another stream…',
    'player.reloadingStream': 'Reloading stream…',
    'player.skippingUnplayable': 'Skipping an unplayable section…',
    'player.nextUnavailableOffline': 'The next episode is not downloaded.',
    'player.episodeUnavailableOffline': 'This episode is not downloaded.',
    'player.nextIn': 'Next episode in {seconds}s',
    'player.playNext': 'Play next',
    'player.cancelAutoNext': 'Cancel',
